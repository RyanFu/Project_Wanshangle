...
@class BarTimeViewController;
@interface BarTimeListTableViewDelegate : NSObject<EGORefreshTableHeaderDelegate,UITableViewDataSource,UITableViewDelegate>{
...
@property(nonatomic,assign) BarTimeViewController *parentViewController;

...
@interface BarPopularListTableViewDelegate(){
    
}
@end

@implementation BarPopularListTableViewDelegate
...
- (void)configureCell:(BarTableViewCell *)cell withObject:(BBar *)abar {
    ...
    cell.bar_popular.text = [NSString stringWithFormat:@"%0.1f",[abar.popular floatValue]];

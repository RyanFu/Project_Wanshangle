...
@interface CinemaDiscountInfoDelegate(){
...
@implementation CinemaDiscountInfoDelegate
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MDiscountTableViewCell *cell = (MDiscountTableViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
...
- (void)configureCell:(MDiscountTableViewCell *)cell cellForRowAtIndexPath:(NSIndexPath *)indexPath withObject:(NSDictionary *)dataDic {
...
-(MDiscountTableViewCell *)createNewCell{
    
    MDiscountTableViewCell * cell = [[[NSBundle mainBundle] loadNibNamed:@"MDiscountTableViewCell" owner:self options:nil] objectAtIndex:0];

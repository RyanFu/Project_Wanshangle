...
{
//    ABLoggerDebug(@"request heads 11111 ======== %@",self.connection.currentRequest.allHTTPHeaderFields);
//    ABLoggerDebug(@"%s status code ========= %d",__PRETTY_FUNCTION__,[(NSHTTPURLResponse *)response statusCode]);
//    ABLoggerDebug(@"%s heads code ========= %@",__PRETTY_FUNCTION__,[(NSHTTPURLResponse *)response allHeaderFields]);
...
{
//    ABLoggerDebug(@"22222222 %s",__PRETTY_FUNCTION__);
//    ABLoggerDebug(@"receive data ========= %0.2fKB",(size += data.length/1024.0));
...
{ABLoggerDebug(@" %s",__PRETTY_FUNCTION__);
